...
const Sidebar: React.FC = () => {
  ...
  const handleBackToLanding = () => {
    // Clear the seen landing flag to show landing page again
    if (typeof Storage !== 'undefined') {
      localStorage.removeItem('optionsworld-seen-landing');
    }
      ...
      <div className="p-4 border-t border-neutral-700">
        <div className="mb-4">
          <button 
            ...
            className="flex items-center w-full px-4 py-2 text-neutral-400 hover:text-neutral-100 rounded-lg hover:bg-neutral-700 transition-colors"
          >
